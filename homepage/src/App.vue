            ...
            <div class="col-xl-4 col-lg-5">
                <div class="featured-text text-center text-lg-left">
                  ...
                  <hr class="d-none d-lg-block mb-4 ml-0">
                    <a href="https://github.com/sieteunoseis/sieteunoseis.github.io/releases/download/v2.7.9/better-bat-app-v.2.7.9.dmg" class="btn btn-primary js-scroll-trigger m-1"><i class="fab fa-apple fa-2x"></i></a>
                    <a href="https://github.com/sieteunoseis/sieteunoseis.github.io/releases/download/v2.7.9/BetterBATInstaller_v2.7.9.exe" class="btn btn-primary js-scroll-trigger m-1"><i class="fab fa-windows fa-2x"></i></a>
                </div>
            </div>
          </div>
