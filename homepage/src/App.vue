  ...
  <div class="main-wrapper">
    <body id="page-top">
      ...
      <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
        <div class="container">
          <a class="navbar-brand js-scroll-trigger" href="#page-top">automate.builders</a>
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href="http://range2pattern.automate.builders/">Range 2 Pattern</a>
                </div>
              </li>
              <li class="nav-item">
                <a class="nav-link js-scroll-trigger" href="https://www.patreon.com/join/sieteunoseis/checkout" target="_blank">Become a Patron!</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <header class="masthead">
        <div class="container d-flex h-100 align-items-center">
          <div class="mx-auto text-center">
            ...
            <h2 class="text-white-50 mx-auto mt-2 mb-5">Tech enthusiast and wanderlust.</h2>
          </div>
        </div>
      </header>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              ...
              <p class="text-white-50">Automate Builders is a side project of mine. It's a place where I can share tools that make managing and configuring collaboration solutions easier. Hopefully it allows us all to work smarter rather than harder.</p>
            </div>
          </div>
          <img src="@/assets/img/automation-5.png" class="img-fluid p-5" alt="">
        </div>
      </section>
      ...
      <section id="projects" class="projects-section bg-light">
            ...
            <div class="col-xl-4 col-lg-5">
                <div class="featured-text text-center text-lg-left">
                  ...
                  <hr class="d-none d-lg-block mb-4 ml-0">
                    <a href="https://github.com/sieteunoseis/sieteunoseis.github.io/releases/download/v2.7.8/better-bat-app-v.2.7.8.dmg" class="btn btn-primary js-scroll-trigger m-1"><i class="fab fa-apple fa-2x"></i></a>
                    <a href="https://github.com/sieteunoseis/sieteunoseis.github.io/releases/download/v2.7.8/BetterBATInstaller_v2.7.8.exe" class="btn btn-primary js-scroll-trigger m-1"><i class="fab fa-windows fa-2x"></i></a>
                </div>
            </div>
          </div>
          ...
          <div class="row justify-content-center no-gutters mb-5 mb-lg-0">
            <div class="col-lg-6">
              <img class="img-fluid" src="@/assets/img/ucconfigurator.png" alt="">
            </div>
            <div class="col-lg-6">
              <div class="bg-black text-center h-100 project">
                <div class="d-flex h-100">
          ...
          <div class="row justify-content-center no-gutters">
            <div class="col-lg-6">
              <img class="img-fluid" src="@/assets/img/cerautomation.png" alt="">
            </div>
            <div class="col-lg-6 order-lg-first">
              <div class="bg-black text-center h-100 project">
                <div class="d-flex h-100">
      ...
      <section class="contact-section bg-black" id="signup">
        <div class="container">
            ...
            <div class="col-md-4 mb-3 mb-md-0">
              <div class="card py-4 h-100">
                <div class="card-body text-center">
                  ...
                  <hr class="my-4">
                  <div class="small text-black-50"><a href="https://goo.gl/maps/cZTNtvzsLeu7SUCq8" target="_blank" class="mx-2">1340 N Webster, Portland, Oregon 97217</a></div>
                </div>
              </div>
            </div>
              ...
              <div class="card py-4 h-100">
                <div class="card-body text-center">
                  ...
                  <div class="small text-black-50">
                    <a href="mailto:jeremy@automate.builders" target="_blank">jeremy@automate.builders</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-4 mb-3 mb-md-0">
              <div class="card py-4 h-100">
                <div class="card-body text-center">
                  ...
                  <hr class="my-4">
                  <div class="small text-black-50">+1 (716) 218-9797</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="social d-flex justify-content-center">
            <a href="https://twitter.com/SieteUnoSeis" target="_blank" class="mx-2">
              <i class="fab fa-twitter"></i>
            </a>
            <a href="https://facebook.com/jeremy.worden" target="_blank" class="mx-2">
              <i class="fab fa-facebook-f"></i>
            </a>
            <a href="https://github.com/sieteunoseis/" target="_blank" class="mx-2">
              <i class="fab fa-github"></i>
            </a>
            <a href="https://www.youtube.com/jeremyworden" target="_blank" class="mx-2">
              <i class="fab fa-youtube"></i>
            </a>
            <a href="https://www.linkedin.com/in/jeremyworden/" target="_blank" class="mx-2">
              <i class="fab fa-linkedin-in"></i>
            </a>
            <a href="https://www.instagram.com/sieteunoseis/" target="_blank" class="mx-2">
              <i class="fab fa-instagram"></i>
            </a>
            <a href="https://www.patreon.com/join/sieteunoseis/checkout" target="_blank" class="mx-2">
